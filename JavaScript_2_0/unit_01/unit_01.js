...
document.querySelector("h2 span").textContent = "world";
...
node.textContent = "Hello from js";
document.querySelector(".three").append(node);
// Task 11.
...
headerNode.textContent = "Hello there";
const paragraphNode = document.createElement("p");
paragraphNode.textContent = "rly hi";
document.querySelector(".four").append(headerNode, paragraphNode);
// Task 12.
