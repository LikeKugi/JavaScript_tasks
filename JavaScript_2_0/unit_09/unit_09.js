...
function f1() {
  document.querySelector(".out-1").style.width = 200 + "px";
  document.querySelector(".out-1").style.height = 40 + "px";
}
...
document
  .querySelectorAll(".out-10")
  .forEach((el) => el.addEventListener("click", f10));
//  Task 11
...
function f11() {
  ...
  divNode.textContent = 25;
  document.querySelector(".out-11").append(divNode);
}
...
function f12() {
  const divNode = document.createElement("div");
  divNode.textContent = 12;
  divNode.classList.add("bg-12");
  document.querySelector(".out-12").append(divNode);
}
...
function f13() {
  const divNode = document.createElement("div");
  divNode.textContent = "pushMe";
  divNode.classList.add("bg-13");
  document.querySelector(".out-13").append(divNode);
  document.querySelector(".bg-13").addEventListener("click", f13_1);
}
...
function f14() {
  const divNode = document.createElement("div");
  divNode.textContent = 14;
  divNode.classList.add("bg-14");
  document.querySelector(".out-14").prepend(divNode);
}
...
function f15() {
  const divNode = document.createElement("div");
  divNode.textContent = 15;
  divNode.classList.add("bg-15");
  document.querySelector(".out-15").before(divNode);
}
...
function f16() {
  const divNode = document.createElement("div");
  divNode.textContent = 16;
  divNode.classList.add("bg-16");
  document.querySelector(".out-16").after(divNode);
}
...
function f17() {
  const divNode = document.createElement("div");
  divNode.textContent = 17;
  divNode.classList.add("bg-17");
  document
    .querySelector(".out-17")
    .parentNode.replaceChild(divNode, document.querySelector(".out-17"));
}
...
function f19() {
  let datas = document.querySelectorAll(".p-19");

  let data = [];
  datas.forEach((el) => data.push(el.getAttribute("data-b")));
  console.log(data);
  document.querySelector(".out-19").textContent = data.join(" ");
}
