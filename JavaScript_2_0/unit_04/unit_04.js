...
function f4() {
  const checkEl = document.querySelector(".i-4");
  document.querySelector(".out-4").textContent = checkEl.checked;
}
...
function f5() {
  const checkEl = document.querySelector(".i-5");
  document.querySelector(".out-5").textContent = !checkEl.checked
    ? false
    : checkEl.value;
}
...
function f6() {
  const checkEl = document.querySelector(".i-6");
  document.querySelector(".out-6").textContent = checkEl.value;
}
...
function f7() {
  const password = document.querySelector(".i-7");
  document.querySelector(".out-71").textContent = password.value;
  document.querySelector(".out-72").textContent =
    password.value.length >= 6 ? 1 : 0;
}
...
function f8() {
  ...
  nodeBtn.textContent = "Submit";
  const nodeInp = document.createElement("input");
  document.querySelector(".out-8").append(nodeBtn, nodeInp);
  const btnEl = document.querySelector(".out-8 button");
  const inpEl = document.querySelector(".out-8 input");
  btnEl.classList.add("b-81");
  inpEl.classList.add("i-81");
  btnEl.onclick = f81;
}
...
function f9() {
  const checkEl = document.querySelector(".r-9");
  document.querySelector(".out-9").textContent = checkEl.checked
    ? checkEl.value
    : "";
}
...
function f10() {
  const color = document.querySelector(".i-10").value;
...
function f16() {
  ...
  const text = document.querySelector(".s-16").value;
...
function f17() {
  const text = document.querySelector(".s-17").value;
  document.querySelector(".out-17").textContent = text;
}
...
function f18() {
  const text = document.querySelector(".s-18").value;
  document.querySelector(".i-18").value = text;
}
...
function f19() {
  const text = document.querySelector(".i-191").value;
  const password = document.querySelector(".i-192").value;

  document.querySelector(".out-19").textContent = text + " " + password;
}
