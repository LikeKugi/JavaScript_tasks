...
function f1() {
  ...
  document.querySelector(".out-1").textContent = value === 4;
}
...
function f3() {
  const fNum = +document.querySelector(".i-31").value;
  const sNum = +document.querySelector(".i-32").value;
  document.querySelector(".out-3").textContent = fNum > sNum ? fNum : sNum;
}
...
function f4() {
  ...
  document.querySelector(".out-4").textContent =
    new Date().getFullYear() - age >= 18 ? 1 : 0;
}
...
function f5() {
  const number = +document.querySelector(".i-5").value;
  let out;
  if (number < 0) out = "m";
  else if (number > 0) out = 1;
  else out = 0;
...
function f6() {
  ...
  document.querySelector(".out-6").textContent = number % 2 ? "ODD" : "EVEN";
}
...
function f7() {
  const val = +document.querySelector(".i-71").value;
  const pow = +document.querySelector(".i-72").value;
  document.querySelector(".out-7").textContent = val ** pow;
}
...
function f9() {
  const room = +document.querySelector(".i-9").value;
  let out = 0;
  if (room > 0 && room < 33) out = 1;
  else if (room > 32 && room < 44) out = 2;
  else if (room > 43 && room < 65) out = 3;
...
function f10() {
  const val = document.querySelector(".s-100").value;
  document.querySelector(".out-10").textContent = val;
}
...
function f11() {
  const val = document.querySelector(".s-110").value;
  document.querySelector(".out-11").textContent = val;
}
...
function f13() {
  const val = +document.querySelector(".i-130").value;
  document.querySelector(".out-13").textContent = typeof val;
}
...
function f14() {
  const fNum = +document.querySelector(".i-141").value;
  const sNum = +document.querySelector(".i-142").value;
  const operator = document.querySelector(".s-143").value;
  let answer;
  switch (operator) {
    case "+":
      answer = fNum + sNum;
  ...
  document.querySelector(".out-14").textContent = answer;
}
...
function f15() {
  const fNum = +document.querySelector(".s-151").value;
  const sNum = +document.querySelector(".s-152").value;
  const operator = document.querySelector(".s-153").value;
  let answer;
  switch (operator) {
    case "&&":
      answer = fNum && sNum;
  ...
  document.querySelector(".out-15").textContent = answer;
}
