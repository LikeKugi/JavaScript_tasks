...
console.log(meanScore(...scores2, ...scores1)) /* все элементы из массивов "scores1" и "scores2" */
// 2.8

console.log(
  meanScore(...scores2, ...scores1, ...scores3) /* все элементы из массивов "scores1", "scores2" и "scores3" */
)
// 2.59
...
function meanScore(...arr) {
    ...
    if (!arr.every(el => Number.isFinite(el))) return "Все аргументы в вызове функции должны быть числами!";
    const mean = arr.reduce((a, e) => a += e);
