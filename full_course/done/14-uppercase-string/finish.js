...
const rndStr = 'some random string';
console.log(rndStr);
console.log(rndStr instanceof String);
console.log(typeof rndStr);

const upperRndStr = rndStr.toUpperCase();
console.log(upperRndStr);